...
class AuthController extends Controller
{
    ...
    public function register(Request $request){
        ...
        Mail::send('verification-email', ['user'=>$user], function($mail) use ($user){
            ...
            $mail->from('navi.brylee5@gmail.com', 'IPT102 Prelim Project');
        });

        Nexmo::message()->send([
            'to' => '+639618166545',
            'from' => 'sender',
            'text' => 'You are successfully registered to our web site. check your email for verification'
        ]);

        return redirect('/login')->with('Message', 'Account has been created, Please check your email and your text messages for the verification.');
    }
